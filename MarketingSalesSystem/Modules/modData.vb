Module modData
    Function getReportSalesInvoice(reportID As Integer, setNum As String, carrier As Integer) As List(Of SalesReportInvoice)
        ...
        Dim sr = (From i In dc.trans_SalesInvoiceBuyers
                  Where i.salesInvoiceID = reportID AndAlso i.setNum = setNum AndAlso i.carrier = carrier AndAlso
                  i.approvalStatus = 1
                  Select i).ToList

        'Dim sr = (From i In dc.trans_SalesInvoiceBuyers
        '          Join j In dc.trans_SalesReportBuyers On i.salesInvoiceID Equals j.salesInvoiceID
        '          Join k In dc.trans_SalesReportPrices On i.salesInvoiceID Equals k.salesReport_ID
        '          Join l In dc.trans_SalesReportCatchers On i.salesInvoiceID Equals l.salesReport_ID
        '          Join m In dc.trans_SalesReports On i.salesInvoiceID Equals m.salesReport_ID
        '          Where i.salesInvoiceID = reportID Select i, j, k).ToList

        'Dim groupSR = sr.
        'GroupBy(Function(x) x.l.catchActivityDetail_ID).
        ...
        For Each s In sr
            ...
            ' Sales Report Column
            'sri.SalesReportID = s.i.salesInvoiceID
            'sri.UnloadingVesselID = ""
            'sri.UnloadingForeignVessel = ""
            sri.Buyer = s.buyerName
